export const idlFactory = ({ IDL }) => {
    const TxId = IDL.Variant({ BlockId: IDL.Nat, TransactionId: IDL.Text });
    ...
    const ICTxIdReply = IDL.Record({
        block_id: IDL.Nat,
        chain: IDL.Text,
        canister_id: IDL.Text,
        symbol: IDL.Text,
    });
    const TxIdReply = IDL.Variant({ IC: ICTxIdReply });
